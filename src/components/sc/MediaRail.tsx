...
export function MediaRail() {
  ...
  if (phase === "empty" || phase === "intake" || phase === "thinking") return null;

  // mobile/tablet: drawer behavior; desktop: always rendered.
  const containerCls = cn(
    "h-full w-[340px] shrink-0 flex-col border-l border-border bg-surface",
    "lg:flex",
    rail.open ? "fixed right-0 top-0 z-30 flex shadow-2xl lg:static lg:shadow-none" : "hidden lg:flex",
  );
